            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="border-t border-gray-800 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-md text-gray-300">Copyright &copy; 2026 Apple Inc. Todos os direitos reservados.</p>
                    ...
                    <p className="text-xs text-gray-500 mt-6">Site criado para fins de estudos próprios</p>
                </div>
            </div>

        ...
        <section id="colors" className="bg-black py-20 px-8">
            ...
            <div className="flex justify-center mb-12">
                ...
                <div className="text-center mt-16">
                    <button className="bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 mb-2 hover:scale-105 shadow-lg shadow-blue-500/50 cursor-pointer">
